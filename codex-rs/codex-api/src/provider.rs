...
impl Provider {
    ...
    pub fn is_azure_responses_endpoint(&self) -> bool {
        is_azure_responses_base_url(&self.name, Some(&self.base_url))
    }
...
pub fn is_azure_responses_base_url(name: &str, base_url: Option<&str>) -> bool {
...
mod tests {
    ...
    fn detects_azure_responses_base_urls() {
        ...
        for base_url in positive_cases {
            assert!(
                is_azure_responses_base_url("test", Some(base_url)),
        ...
        assert!(is_azure_responses_base_url("Azure", None));
    }
}
