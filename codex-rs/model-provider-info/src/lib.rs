...
pub enum WireApi {
    ...
    #[default]
    Responses,
    /// DeepSeek-compatible Chat Completions transport exposed at `/chat/completions`.
    ///
    /// The first implementation serializes DeepSeek request options such as
    /// `thinking` and DeepSeek reasoning effort. Do not treat this as a generic
    /// provider-neutral Chat Completions contract without adding provider-specific
    ...
    pub fn create_deepseek_provider() -> ModelProviderInfo {
        ModelProviderInfo {
            ...
            env_key_instructions: Some(
                "Create a DeepSeek API key at https://platform.deepseek.com/api_keys and export DEEPSEEK_API_KEY.".into(),
            ),
            experimental_bearer_token: None,
            auth: None,
            aws: None,
