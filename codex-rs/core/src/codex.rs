...
impl Session {
    ...
    fn make_turn_context(
        ...
        // [SA] COMMIT OPEN: apply thread-spawn tool policy
        // Role: enforce template-defined allow_list/deny_list for spawned agent turns.
        // [SA] legacy: turn tools_config was built without per-agent tool filters.
        ...
        // [SA] COMMIT CLOSE: apply thread-spawn tool policy
