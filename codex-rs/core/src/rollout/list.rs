...
pub struct ThreadItem {
    ...
    /// Persona (agent_persona) from session metadata for AgentControl-spawned sub-agents.
        ...
        match rollout_line.item {
            RolloutItem::SessionMeta(session_meta_line) => {
                if !summary.saw_session_meta {
                    ...
                    summary.agent_persona = session_meta_line
                        .meta
                        .source
                        .get_agent_persona()
                        .or_else(|| session_meta_line.meta.agent_persona.clone());
