...
pub const TUI_VISIBLE_COLLABORATION_MODES: [ModeKind; 3] =
    [ModeKind::Default, ModeKind::Interactive, ModeKind::Plan];
...
impl ModeKind {
    ...
    pub const fn is_tui_visible(self) -> bool {
        matches!(self, Self::Plan | Self::Interactive | Self::Default)
    }
...
mod tests {
    ...
    fn tui_visible_collaboration_modes_match_mode_kind_visibility() {
        let expected = [ModeKind::Default, ModeKind::Interactive, ModeKind::Plan];
