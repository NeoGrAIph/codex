...
use crate::bottom_pane::SubagentWorkbenchAction;
use crate::bottom_pane::SubagentWorkbenchActionKind;
use crate::bottom_pane::SubagentWorkbenchRow;
...
mod agent_workbench_read_model;
...
use self::agent_navigation::AgentPickerThreadDetail;
use self::agent_workbench_read_model::AgentWorkbenchDetailSummaries;
use self::agent_workbench_read_model::AgentWorkbenchReadModel;
