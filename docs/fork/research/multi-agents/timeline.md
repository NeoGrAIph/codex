...
Статус исследования: покрыты и зафиксированы stable-релизы `rust-v0.81.0`-`rust-v0.140.0`. Основной timeline строится только по stable tags. Alpha tags используются только как дополнительное evidence, если это потребуется отдельно.
