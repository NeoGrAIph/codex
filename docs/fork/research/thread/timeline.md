...
Статус исследования: покрыты stable-релизы `rust-v0.86.0`-`rust-v0.144.1`. Scope намеренно начинается с `rust-v0.86.0`; более ранняя история app-server и первичный v2 `thread/*` bootstrap не восстанавливаются в этом timeline.
