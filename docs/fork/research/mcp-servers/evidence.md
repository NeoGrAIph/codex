...
- Исследованный literal range: `rust-v0.142.5^{}..rust-v0.144.1^{}` (`26de83050b20f7e0ee211b9739e52ae00ce8032a..44918ea10c0f99151c6710411b4322c2f5c96bea`). Выражение `A..B` означает множество commits, достижимых из `B`, но не достижимых из `A`; оно не утверждает, что `A` является предком `B` или что stable refs образуют последовательную ancestry-цепочку.
- Промежуточные stable refs: `rust-v0.143.0^{}` = `c4d748f586a84a3ed5b6aceb82e9a1db4abb1cda`, `rust-v0.144.0^{}` = `767822446c7a594caa19609ca435281a9ec67e0d`.
- Верхняя stable граница локального исследования: `rust-v0.144.1`.
...
git log rust-v0.142.5^{}..rust-v0.144.1^{} --reverse --date=short --format='%H%x09%ad%x09%s'
git log rust-v0.142.5^{}..rust-v0.144.1^{} --reverse --date=short --format='%H%x09%ad%x09%s' -- <mcp-paths>
...
## `rust-v0.144.1` source inspection
