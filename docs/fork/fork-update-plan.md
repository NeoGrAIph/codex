...
### Этап 3: TUI‑слой
- Оставить fork‑маркер версии.
- Остальные UX‑обновления максимально синхронизировать с upstream.

### Этап 4: app-server-protocol
...
- `cargo test -p codex-tui` (если затронут UI/снапшоты)
