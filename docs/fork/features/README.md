...
| --- | --- | --- | --- |
| [Native multi_agent_v1 child under V2](multi-agent-v1-native-child-under-v2.md) | Effective-V2 models получают дополнительный native V1 tool surface; spawn создаёт настоящий UUID/pathless V1 child с V1 lifecycle и persistence. | `a5e21107643d` повторно перенесён и адаптирован в `fork/145`; focused verification, domain/integration audits и current build завершены, cross-platform CI остаётся release gate | `fork/144.4`, `fork/145` |
