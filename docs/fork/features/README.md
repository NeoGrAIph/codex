...
| --- | --- | --- | --- |
| [Native multi_agent_v1 child under V2](multi-agent-v1-native-child-under-v2.md) | Effective-V2 models получают дополнительный native V1 tool surface; V1/V2 agents можно permanently закрывать по UUID или canonical task name без взаимного расходования V1 capacity V2 catalog entries. | `a5e21107643d` повторно перенесён и адаптирован в `fork/145`; cross-runtime lifecycle follow-up проходит focused verification, cross-platform CI остаётся release gate | `fork/144.4`, `fork/145` |
